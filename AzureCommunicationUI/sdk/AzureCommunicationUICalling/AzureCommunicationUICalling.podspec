Pod::Spec.new do |spec|
  ...
  spec.homepage             = "https://github.com/hassnain-ali/communication-ui-library-ios"
  spec.license              = { :type => 'MIT' }
  spec.author               = 'Microsoft'
  spec.source               = { :git => 'https://github.com/hassnain-ali/communication-ui-library-ios.git', :tag => 'AzureCommunicationUICalling_1.14.2' }
  ...
  spec.dependency             'AzureCommunicationCalling', '2.16.0-beta.1'
